 ...
 * @property \Cake\ORM\Association\HasMany $PagePayee
 *
...
class ArticlesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('nombre_page')
            ->requirePresence('nombre_page', 'create')
            ->notEmpty('nombre_page');

        $validator
            ->integer('extra_page')
            ->requirePresence('extra_page', 'create')
            ->notEmpty('extra_page');
