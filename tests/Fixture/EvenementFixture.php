 ...
 *
 */
class EvenementFixture extends TestFixture
{
    ...
    public $fields = [
        'evenement_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['evenement_id'], 'length' => []],
